...
const ENCODE_PROFILES = {
  speed: {
    ...
    crf: 26,
    quality: '🟡 lumayan',
    note: 'Paling kenceng. CRF awal 26; auto-size bisa naik s/d 30 biar file mengecil. Aman rekam panjang.',
  },
  balanced: {
    key: 'balanced',
    label: '🟢 Cepat (Default)',
  ...
  quality: {
    ...
    crf: 24,
    quality: '🟢🟢 lebih oke',
    note: 'Lebih bersih. CRF awal 24; kalau masih besar auto naik CRF (max 30) biar mengecil.',
  },
  max: {
    key: 'max',
    label: '🟢🟢🟢 Maksimal',
    ...
    crf: 22,
    quality: '🟢🟢🟢 transparan',
    note: 'Kualitas tinggi. CRF awal 22; auto-size tetap cegah file membengkak (max CRF 30).',
  },
};
